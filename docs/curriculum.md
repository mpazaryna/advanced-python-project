...
- \[ \] Use Jupyter notebooks in the `notebooks/` directory for exploratory data analysis and to
  document your thought process

Remember to adjust the schedule as needed based on your progress and the specific requirements of
your project. Good luck with your learning journey!
